    ...
    return (
        <div>
            ...
            <footer className="p-4 bg-white rounded-lg shadow md:px-6 md:py-8 dark:bg-gray-900">
                ...
                <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">©<Link href={process.env.githubURL} className="hover:underline">Fenil Sonani</Link>. All Rights Reserved.
                </span>
            </footer>
